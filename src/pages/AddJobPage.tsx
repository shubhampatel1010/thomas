...
export default function AddJobPage({ userId, onNavigate, onShowToast }: AddJobPageProps) {
    ...
    <div className="min-h-screen bg-gray-50">
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div className="bg-white rounded-xl shadow-sm p-8">
          <h1 className="text-3xl font-bold text-gray-900 mb-2">Add Job Posting</h1>
          <p className="text-gray-600 mb-8">Fill in the details to create a new job posting</p>
